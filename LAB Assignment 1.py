...
STATUS: You are within your daily calorie limit.import datetime as dt
print("\033[1;33m[============================================================= WELCOME =============================================================]\033[0m")
print("\033[1;33m[======================================================= DAILY CALORIE TRACKER =======================================================]\033[0m")

print()
print("NAME : Manoj Kumar")  # about me
print("ROLL NUMBER : 2501730119")
...
if save_choice == "yes":
    ...
    with open("calorie_log.txt", "w") as file:
        ...
        file.write(f"NAME: Manoj Kumar \n")
        file.write(f"ROLL NUMBER: 2501730119\n")
